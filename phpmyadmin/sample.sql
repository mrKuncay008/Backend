...
CREATE TABLE  ORDERS
   (
        ORD_NUM INT(6,0) NOT NULL PRIMARY KEY,
	ORD_AMOUNT INT(12,2) NOT NULL,
	ADVANCE_AMOUNT INT(12,2) NOT NULL,
...
INSERT INTO ORDERS VALUES('200100', '1000.00', '600.00', '2022-08-01', 'C00013', 'A003', 'SOD');
INSERT INTO ORDERS VALUES('200110', '3000.00', '500.00', '2022-04-15', 'C00019', 'A010', 'SOD');
INSERT INTO ORDERS VALUES('200107', '4500.00', '900.00', '2022-08-30', 'C00007', 'A010', 'SOD');
INSERT INTO ORDERS VALUES('200112', '2000.00', '400.00', '2022-05-30', 'C00016', 'A007', 'SOD');
INSERT INTO ORDERS VALUES('200113', '4000.00', '600.00', '2022-06-10', 'C00022', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200102', '2000.00', '300.00', '2022-05-25', 'C00012', 'A012', 'SOD');
INSERT INTO ORDERS VALUES('200114', '3500.00', '2000.00','2022-08-15', 'C00002', 'A008', 'SOD');
INSERT INTO ORDERS VALUES('200122', '2500.00', '400.00', '2022-09-16', 'C00003', 'A004', 'SOD');
INSERT INTO ORDERS VALUES('200118', '500.00', '100.00',  '2022-07-20', 'C00023', 'A006', 'SOD');
INSERT INTO ORDERS VALUES('200119', '4000.00', '700.00', '2022-09-16', 'C00007', 'A010', 'SOD');
INSERT INTO ORDERS VALUES('200121', '1500.00', '600.00', '2022-09-23', 'C00008', 'A004', 'SOD');
INSERT INTO ORDERS VALUES('200130', '2500.00', '400.00', '2022-07-30', 'C00025', 'A011', 'SOD');
INSERT INTO ORDERS VALUES('200134', '4200.00', '1800.00','2022-09-25', 'C00004', 'A005', 'SOD');
INSERT INTO ORDERS VALUES('200108', '4000.00', '600.00', '2022-02-15', 'C00008', 'A004', 'SOD');
INSERT INTO ORDERS VALUES('200103', '1500.00', '700.00', '2022-05-15', 'C00021', 'A005', 'SOD');
INSERT INTO ORDERS VALUES('200105', '2500.00', '500.00', '2022-07-18', 'C00025', 'A011', 'SOD');
INSERT INTO ORDERS VALUES('200109', '3500.00', '800.00', '2022-07-30', 'C00011', 'A010', 'SOD');
INSERT INTO ORDERS VALUES('200101', '3000.00', '1000.00','2022-07-15', 'C00001', 'A008', 'SOD');
INSERT INTO ORDERS VALUES('200111', '1000.00', '300.00', '2022-07-10', 'C00020', 'A008', 'SOD');
INSERT INTO ORDERS VALUES('200104', '1500.00', '500.00', '2022-03-13', 'C00006', 'A004', 'SOD');
INSERT INTO ORDERS VALUES('200106', '2500.00', '700.00', '2022-04-20', 'C00005', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200125', '2000.00', '600.00', '2022-10-10', 'C00018', 'A005', 'SOD');
INSERT INTO ORDERS VALUES('200117', '800.00', '200.00',  '2022-10-20', 'C00014', 'A001', 'SOD');
INSERT INTO ORDERS VALUES('200123', '500.00', '100.00',  '2022-09-16', 'C00022', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200120', '500.00', '100.00',  '2022-07-20', 'C00009', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200116', '500.00', '100.00',  '2022-07-13', 'C00010', 'A009', 'SOD');
INSERT INTO ORDERS VALUES('200124', '500.00', '100.00',  '2022-06-20', 'C00017', 'A007', 'SOD');
INSERT INTO ORDERS VALUES('200126', '500.00', '100.00',  '2022-06-24', 'C00022', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200129', '2500.00', '500.00', '2022-07-20', 'C00024', 'A006', 'SOD');
INSERT INTO ORDERS VALUES('200127', '2500.00', '400.00', '2022-07-20', 'C00015', 'A003', 'SOD');
INSERT INTO ORDERS VALUES('200128', '3500.00', '1500.00','2022-07-20', 'C00009', 'A002', 'SOD');
INSERT INTO ORDERS VALUES('200135', '2000.00', '800.00', '2022-09-16', 'C00007', 'A010', 'SOD');
INSERT INTO ORDERS VALUES('200131', '900.00', '150.00',  '2022-08-26', 'C00012', 'A012', 'SOD');
INSERT INTO ORDERS VALUES('200133', '1200.00', '400.00', '2022-06-29', 'C00009', 'A002', 'SOD');
...
-- UPDATE
UPDATE CUSTOMER
SET PHONE_NO = "002-9219909"
WHERE CUST_CODE = 'C00009';

UPDATE CUSTOMER
SET PHONE_NO = "012-2121109"
WHERE CUST_CODE = 'C00010';

UPDATE CUSTOMER
SET PHONE_NO = "011-921929"
WHERE CUST_CODE = 'C00011';

UPDATE CUSTOMER
SET PHONE_NO = "022-2219309"
WHERE CUST_CODE = 'C00012';

UPDATE CUSTOMER
SET PHONE_NO = "092-929239"
WHERE CUST_CODE = 'C00013';

UPDATE CUSTOMER
SET PHONE_NO = "092-929239"
WHERE CUST_CODE = 'C00014';
...
UPDATE CUSTOMER
SET PHONE_NO = "092-9291239"
WHERE CUST_CODE = 'C00016';

UPDATE CUSTOMER
SET PHONE_NO = "092-9293239"
WHERE CUST_CODE = 'C00017';

UPDATE CUSTOMER
SET PHONE_NO = "092-92921239"
WHERE CUST_CODE = 'C00018';

UPDATE CUSTOMER
SET PHONE_NO = "092-921139"
WHERE CUST_CODE = 'C00019';

UPDATE CUSTOMER
SET PHONE_NO = "092-92239"
WHERE CUST_CODE = 'C00020';

UPDATE CUSTOMER
SET PHONE_NO = "012-9212109"
WHERE CUST_CODE = 'C00021';

UPDATE CUSTOMER
SET PHONE_NO = "012-4321109"
WHERE CUST_CODE = 'C00022';

UPDATE CUSTOMER
SET PHONE_NO = "011-1221929"
WHERE CUST_CODE = 'C00023';

UPDATE CUSTOMER
SET PHONE_NO = "022-2029309"
WHERE CUST_CODE = 'C00024';

UPDATE CUSTOMER
SET PHONE_NO = "192-9290239"
